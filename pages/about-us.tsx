...
export default function About() {
  ...
  <section className="mb-32 text-gray-800">
    ...
    <p>Little Wonders Play and Learn Center offers quality preschool program with unique ambience and curriculum where children of age 2-6 years get the opportunity to develop learning abilities through play based approach.</p>
...
<div className="flex flex-wrap -m-4">
    ...
    postition="Centre in charge – Uttara branch" 
    ...
    postition="Executive Admin and Accounts " 
    ...
    postition="Centre in charge – Gulshan branch " 
    ...
    postition="Occupational Therapist" 
   ...
   "  
    ...
    postition="Speech and Language Therapist" 
    ...
    postition="Clinical Audiologist and Speech Language" 
    joining_date="Since May 2023"
    view="As a speech-language therapist, I provide life-changing treatment, support, and care for children and adults who have difficulties with speech, language, voice, fluency and swallowing. That's why I love and respect my healthcare profession."  
    />
    <Member 
    staff_name="Kaosar Khan" 
    postition="Clinical Audiologist and Speech Language Pathologist" 
    joining_date="Since May 2023"
    view="My profession is more important to me than anything else.
    It is a noble profession, I always like to work as audiologist and
    
    speech therapist. I always put in my best effort and provide the best service to all my patients."  
    />
